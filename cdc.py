def main():
    ...
    #funções
    saida(parcela_co, parcela_cdc, meses_parcelas, entrada_lance)
    melhor_opcao(parcela_co, meses_parcelas,entrada_lance,parcela_cdc)

def melhor_opcao(parcela_co, meses_parcelas,entrada_lance,parcela_cdc):
...
def cdc(entrada, juros, meses):
    ...
    parcela = (valor_a_parcelar / meses) + (juros * valor_a_parcelar / 100)
    return parcela

def saida(parcela_co, parcela_cdc, meses_parcelas, entrada_lance):
